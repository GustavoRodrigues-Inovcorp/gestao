...
import { Plus, Pencil, Trash2, FileDown, ArrowRight, X } from 'lucide-vue-next'
    ...
    fetch(`/encomendas/${encomenda.id}/linhas`)
        ...
        .then(linhas => {
            Object.assign(editForm, defaultForm({
                entidade_id: encomenda.entidade_id,
                validade: encomenda.validade_raw,
...
<template>
    <AppLayout>
        <template #header>
            <h1 class="text-sm font-semibold">Encomendas — Clientes</h1>
        </template>
            ...
            <div class="flex justify-end">
                <Dialog v-model:open="showCreate">
                    ...
                    <DialogContent class="max-w-4xl max-h-[90vh] overflow-y-auto">
                        <DialogHeader>
                            <DialogTitle>Nova Encomenda — Nº {{ proximoNumero }}</DialogTitle>
                        </DialogHeader>
                        <div class="space-y-4 py-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div v-for="(linha, i) in createForm.linhas" :key="i" class="rounded-md border p-3 space-y-2">
                                    ...
                                    <!-- Identificação do artigo e fornecedor da linha. -->
                                    ...
                                    <!-- Quantidades e valores usados no cálculo do subtotal. -->
