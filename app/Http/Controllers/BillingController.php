    ...
    public function index()
    {
        ...
        return Inertia::render('Billing/Index', [
            ...
            'subscricao' => $subscricao ? [
                ...
                'trial_fim'       => $subscricao->trial_fim?->format('d/m/Y'),
                'dias_trial'      => $subscricao->diasRestantesTrial(),
                'inicio'          => $subscricao->inicio?->format('d/m/Y'),
                'proximo_ciclo'   => $subscricao->proximo_ciclo?->format('d/m/Y'),
                'cancelado_em'    => $subscricao->cancelado_em?->format('d/m/Y'),
